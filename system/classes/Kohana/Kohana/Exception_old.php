...
class Kohana_Kohana_Exception extends Exception {
	 ...
	 * @param   Exception  $e
	 * @return  void
	 * Pour une compatibilité avec php7 enlever les Exceptions et laisser $e
	 * exemple function handler(Exception $e) => function handler($e)
	 * function handler,function _handler,function log,function text,function response
	 */
