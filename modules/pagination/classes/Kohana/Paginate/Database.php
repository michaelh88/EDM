...
class Kohana_Paginate_Database extends Paginate
{
	...
	protected function _sort($column, $direction)
	{
		...
		$this->_object->order_by($column, mysqli_real_escape_string(Database_MySQLi::$_last_connection_handle,$direction));
	}
	...
	protected function _search($query)
	{
		...
		if (count($columns) > 0)
		{
			...
			$query = '%' . mysqli_real_escape_string(Database_MySQLi::$_last_connection_handle,$query) . '%';
